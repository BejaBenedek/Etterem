...
while kileptele == False:
                ...
                while rendeles_folyamatban:
                    ...
                    if rendel_e == "igen":
                        ...
                        if menu.rajtavane(rendeles):
                            eredmeny = raktar.kivonas(rendeles)
                            if eredmeny != "nincs elég hozzávaló a raktárban":
                                vasarlok.rendeles_mentese(
                                    osszesasztal[mostani_asztalindex].vasarlo_neve,
                                    rendeles,
                                    menu.ar(rendeles)
                                )
                            else:
    ...
    while admin == True:
        ...
        if gomb == b'\r' and lehetosegek[a] == "lezárt rendelések kiírása":
            os.system("cls")
            lezart_rendeles.kiiras()
            gomb = msvcrt.getch()
            if gomb == b'd':
                os.system("cls")
                admin = True
